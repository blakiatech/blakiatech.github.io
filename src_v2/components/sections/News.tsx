...
import { ReviewCard } from "./news/ReviewCard";
import { ReviewDialog } from "./news/ReviewDialog";

export function News() {
    return (
        <section id="news" className="py-32 relative overflow-hidden bg-background dark:bg-zinc-950 text-foreground dark:text-white transition-colors duration-300">
            {/* Background Effects */}
